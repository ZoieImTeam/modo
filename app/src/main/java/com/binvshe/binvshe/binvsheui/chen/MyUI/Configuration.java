...
public class Configuration implements Cloneable {
	...
	public static com.binvshe.binvshe.binvsheui.chen.MyUI.Configuration getDefault(float density) {
		com.binvshe.binvshe.binvsheui.chen.MyUI.Configuration defaultConfiguration = new com.binvshe.binvshe.binvsheui.chen.MyUI.Configuration();
