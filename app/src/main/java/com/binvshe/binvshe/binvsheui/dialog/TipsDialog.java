...
public class TipsDialog extends DialogFragment implements View.OnClickListener {
    ...
    public static TipsDialog newInstance(String content, String left, String right) {
        TipsDialog newFragment = new TipsDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.dialog_tip, container, false);
