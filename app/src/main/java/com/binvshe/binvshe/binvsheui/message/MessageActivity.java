 ...
 */
public class MessageActivity extends AbsFragmentActivity implements IViewModelInterface {
...
//        message = (TextView) findViewById(R.id.fr_message_message);
//        message.setOnClickListener(this);
//        friend = (TextView) findViewById(R.id.fr_message_friend);
//        friend.setOnClickListener(this);
//        ImageView indicator = (ImageView) findViewById(R.id.fr_message_indicator);
        pager = (ViewPager) findViewById(R.id.fr_message_pager);
...
//        y = ObjectAnimator.ofFloat(indicator, "x", DimensionsUtil.dip2px(90, this), width - DimensionsUtil.dip2px(155, this));
//        y.setDuration(500);
    }
