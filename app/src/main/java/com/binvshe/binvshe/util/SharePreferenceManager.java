...
//	private Context context = null;
	...
	public static SharedPreferences getSharedPreferences(
		...
		SharedPreferences preferences = applicationContext
				.getSharedPreferences(PreferenceUtil.CURRENTTIME, Context.MODE_PRIVATE);
		return preferences;
	}
	/**
	 * 
	 ...
	 * @param isFull
	 */
	public static void setCurrentTime(Context applicationContext,
			String currentDate) {
		getSharedPreferences(applicationContext).edit().putString(PreferenceUtil.ISTIME, currentDate).commit();
	}

	/**
	 * 获取上次存储的时间
	 */
	public static String getSaveTime(Context applicationContext) {
		return getSharedPreferences(applicationContext).getString(PreferenceUtil.ISTIME,PreferenceUtil.ISTIMEDEAULT);
